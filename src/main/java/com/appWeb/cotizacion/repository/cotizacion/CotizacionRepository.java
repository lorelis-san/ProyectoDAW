...
public interface CotizacionRepository extends JpaRepository<Cotizacion, Long> {
    ...
    WHERE 
        ...
        LOWER(cli.businessName) LIKE LOWER(CONCAT('%', :term, '%')) OR
        LOWER(cli.firstName) LIKE LOWER(CONCAT('%', :term, '%')) OR
        LOWER(cli.lastName) LIKE LOWER(CONCAT('%', :term, '%')) OR
        LOWER(cli.email) LIKE LOWER(CONCAT('%', :term, '%')) OR
